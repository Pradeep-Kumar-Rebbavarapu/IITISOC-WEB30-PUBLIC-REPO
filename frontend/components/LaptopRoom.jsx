								...
								<div className="w-full h-full grid grid-cols-4 justify-between items-center">
									...
									<div onClick={() => {
										...
										<div
											...
											className="border-0 rounded-lg p-2  mx-auto text-orange-500  transition-all fade-in-out  "
										>
											{ScreenShareOn ? (
									...
									<div onClick={() => {
										...
										<div
											...
											className="border-0 rounded-lg p-2 w-fit mx-auto text-orange-500  transition-all fade-in-out "
										>
						...
						>
							...
							<div className="bg-gray-200 w-full h-full  grid grid-rows-[80px_auto_80px] rounded-lg">
								...
								<div
									...
									id="SendMessage"
									className="w-full  border-0 border-black p-3 "
								>
