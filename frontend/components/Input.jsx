                        ...
                        (props2) => {
                            ...
                            return (
                                ...
                                <div className="relative w-full h-[50px] border-b-2 border-[#162983] my-[30px] flex">
                                    ...
                                    <input {...field} className="w-full h-full bg-transparent border-none outline-none peer font-semibold pr-8 pl-1 dark:text-black" required name={name} id={name} type={type} />
